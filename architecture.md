...
### 6. Onglet Objectif (D�di�) & Internationalisation
**Date**: 01/01/2026
**Fichiers Modifi�s**: pp/(tabs)/goals.tsx, pp/(tabs)/index.tsx, constants/quotes.ts, i18n/*

**Description**:
- Cr�ation d'un onglet d�di� aux objectifs pour un suivi d�taill�.
- Ajout de citations dynamiques multilingues.
- Support complet de l'Arabe (RTL readiness, traductions).

**Fonctionnement**:
- **Onglet Objectif** :
  - **Vue**: Calandrier des succ�s (eact-native-calendars) + Stats.
...
- **Citations Dynamiques** :
  ...
  - Source centralis�e : constants/quotes.ts (FR/EN/AR).
- **Internationalisation** :
  - Structuration optimis�e des fichiers JSON (correction des nids 'dashboard.goals').
  - Traduction int�grale (Icones, Titres, Dialogues).
